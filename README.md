...
**Mistral Hackathon - Distral AI**
- Built in **28 hours** at the **Mistral × AWS Hackathon ** with Eliott (https://github.com/eliottvalette) and Nicolas(https://github.com/NgrimaldiN).  
A **free-will narrative simulation game** where you play the company’s internal AI assistant inside an OS, facing unscripted interactions with **Mistral-powered LLM NPCs**.  

...
### Highlights
- [Voodoo x Anthropic Hackathon 2026](https://anthropic-voodoo-hackathon.vercel.app/): **Winner of Track 2** (Marketing Automation, 7 teams). Generic pipeline that turns any gameplay video into a single-file HTML playable ad, AppLovin-compliant (≤ 5 MB, MRAID 2.0). Stack: Gemini for video analysis, Scenario.com for asset generation, Claude Haiku for orchestration, Claude Sonnet 4.6 for HTML codegen, Playwright for compliance verification. Live demo on three games: Castle Clashers (2D), Block Blast (2D), Epic Plane Evolution (3D). Built with [Eliott](https://github.com/eliottvalette) and [Nicolas](https://github.com/NgrimaldiN).
